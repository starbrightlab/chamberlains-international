      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/buy" className="opacity-75 hover:opacity-100 transition-opacity">Buy Property</Link></li>
              <li><Link href="/sell" className="opacity-75 hover:opacity-100 transition-opacity">Sell Property</Link></li>
              <li><Link href="/property-management" className="opacity-75 hover:opacity-100 transition-opacity">Property Management</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="tel:+14075697595" className="opacity-75 hover:opacity-100 transition-opacity">
                  +1 (407) 569-7595
                </a>
              </li>
              <li>
                <a href="tel:+18638528418" className="opacity-75 hover:opacity-100 transition-opacity">
                  Fax: +1 (863) 852-8418
                </a>
              </li>
              <li>
                <a href="mailto:info@chamberlainsinternational.com" className="opacity-75 hover:opacity-100 transition-opacity">
        ...
        <div className="border-t border-white/10 pt-6 mt-6">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm opacity-75 gap-4">
            ...
            <p>Website by <a href="https://starbrightlab.com" className="hover:text-chamberlains-blue transition-colors">Starbright Lab LLC</a></p>
          </div>
        </div>
      </div>
    </footer>
